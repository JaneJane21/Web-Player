...
@endsection
@section('content')
<div class="container mt-5 mb-5 pb-5" id="My-Beats">
    <div class="mt-5 mb-5" :class="message?'alert alert-light':''">
    @{{ message }}
    </div>

    <div v-if="tracks.length > 0 || albums.length > 0 || search_playlists.length > 0" class="row mb-5 pb-5">
        <h6 v-if="tracks.length > 0" style="color: white;">МОИ БИТЫ</h6>
...
<script>
    ...
    Vue.createApp(app).mount('#My-Beats')
</script>
